...
public class IDFObjectSeq_V8_2 implements ObjectSeq {
    ...
    private static void initObjectSeq(){
        ...
        objectSeq.put("site:grounddomain", 216);
        ...
        objectSeq.put("construction:windowequivalentlayer", 424);
        objectSeq.put("windowmaterial:gap:equivalentlayer", 425);
        objectSeq.put("materialproperty:moisturepenetrationdepth:settings", 426);
        objectSeq.put("materialproperty:phasechange", 427);
