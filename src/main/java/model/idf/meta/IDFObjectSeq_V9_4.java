...
public class IDFObjectSeq_V9_4 implements ObjectSeq{
    ...
    private static void initObjectSeq(){
        ...
        objectSeq.put("airterminal:singleduct:constantvolume:reheat", 1901);
        objectSeq.put("airterminal:singleduct:constantvolume:noreheat", 1902);
        ...
        objectSeq.put("outputcontrol:files", 5621);
        objectSeq.put("output:json", 5622);
        objectSeq.put("output:sqlite", 5623);
        objectSeq.put("output:environmentalimpactfactors", 5624);
        objectSeq.put("environmentalimpactfactors", 5625);
        objectSeq.put("fuelfactors", 5626);
        objectSeq.put("output:diagnostics", 5627);
        objectSeq.put("output:debuggingdata", 5628);
        objectSeq.put("output:preprocessormessage", 5629);
    ...
    private static void initCategorySeq(){
        ...
        categorySeq.put(57, "Python Plugin System");
    }
