...
public class IDFObjectSeq_V8_6 implements ObjectSeq {
    ...
    private static void initObjectSeq(){
        ...
        objectSeq.put("surfaceproperty:solarincidentinside", 616);
        objectSeq.put("complexfenestrationproperty:solarabsorbedlayers", 617);
        objectSeq.put("zoneproperty:userviewfactors:bysurfacename", 618);
        ...
        objectSeq.put("airflownetwork:occupantventilationcontrol", 1227);
        objectSeq.put("airflownetwork:intrazone:node", 1228);
        objectSeq.put("airflownetwork:intrazone:linkage", 1229);
        ...
        objectSeq.put("faultmodel:thermostatoffset", 4907);
        objectSeq.put("faultmodel:humidistatoffset", 4908);
        objectSeq.put("faultmodel:fouling:airfilter", 4909);
        objectSeq.put("faultmodel:fouling:coil", 4910);
