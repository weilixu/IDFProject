...
public class IDFObjectSeq_V8_3 implements ObjectSeq {
    ...
    private static void initObjectSeq(){
        ...
        objectSeq.put("site:grounddomain:slab", 216);
        objectSeq.put("site:grounddomain:basement", 217);
        ...
        objectSeq.put("site:solarandvisiblespectrum", 223);
        objectSeq.put("site:spectrumdata", 224);
        ...
        objectSeq.put("airterminal:singleduct:inletsidemixer", 1912);
        objectSeq.put("airterminal:singleduct:supplysidemixer", 1913);
        ...
        objectSeq.put("coil:cooling:dx:singlespeed:thermalstorage", 2233);
        ...
        objectSeq.put("unitarysystemperformance:heatpump:multispeed", 2602);
        ...
        objectSeq.put("faultmodel:fouling:coil", 4909);
        ...
        objectSeq.put("outputcontrol:table:style", 5611);
        objectSeq.put("outputcontrol:reportingtolerances", 5612);
        objectSeq.put("output:variable", 5613);
        objectSeq.put("output:meter", 5614);
        objectSeq.put("output:meter:meterfileonly", 5615);
        objectSeq.put("output:meter:cumulative", 5616);
        objectSeq.put("output:meter:cumulative:meterfileonly", 5617);
        objectSeq.put("meter:custom", 5618);
        objectSeq.put("meter:customdecrement", 5619);
        objectSeq.put("output:sqlite", 5620);
        objectSeq.put("output:environmentalimpactfactors", 5621);
        objectSeq.put("environmentalimpactfactors", 5622);
        objectSeq.put("fuelfactors", 5623);
        objectSeq.put("output:diagnostics", 5624);
        objectSeq.put("output:debuggingdata", 5625);
        objectSeq.put("output:preprocessormessage", 5626);
    }
