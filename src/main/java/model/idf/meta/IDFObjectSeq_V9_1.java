...
public class IDFObjectSeq_V9_1 implements ObjectSeq{
    ...
    private static void initObjectSeq(){
        ...
        objectSeq.put("demandmanager:ventilation", 4606);
        ...
        objectSeq.put("electricloadcenter:storage:converter", 4731);
