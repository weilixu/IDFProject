...
public class IDFObjectSeq_V9_3 implements ObjectSeq{
    ...
    private static void initObjectSeq(){
        ...
        objectSeq.put("performanceprecisiontradeoffs", 3);
        objectSeq.put("building", 4);
        objectSeq.put("shadowcalculation", 5);
        objectSeq.put("surfaceconvectionalgorithm:inside", 6);
        objectSeq.put("surfaceconvectionalgorithm:outside", 7);
        objectSeq.put("heatbalancealgorithm", 8);
        objectSeq.put("heatbalancesettings:conductionfinitedifference", 9);
        objectSeq.put("zoneairheatbalancealgorithm", 10);
        objectSeq.put("zoneaircontaminantbalance", 11);
        objectSeq.put("zoneairmassflowconservation", 12);
        objectSeq.put("zonecapacitancemultiplier:researchspecial", 13);
        objectSeq.put("timestep", 14);
        objectSeq.put("convergencelimits", 15);
        objectSeq.put("hvacsystemrootfindingalgorithm", 16);
        ...
        objectSeq.put("site:groundtemperature:undisturbed:finitedifference", 216);
        objectSeq.put("site:groundtemperature:undisturbed:kusudaachenbach", 217);
        objectSeq.put("site:groundtemperature:undisturbed:xing", 218);
        objectSeq.put("site:grounddomain:slab", 219);
        objectSeq.put("site:grounddomain:basement", 220);
        objectSeq.put("site:groundreflectance", 221);
        objectSeq.put("site:groundreflectance:snowmodifier", 222);
        objectSeq.put("site:watermainstemperature", 223);
        objectSeq.put("site:precipitation", 224);
        objectSeq.put("roofirrigation", 225);
        objectSeq.put("site:solarandvisiblespectrum", 226);
        objectSeq.put("site:spectrumdata", 227);
        ...
        objectSeq.put("schedule:file:shading", 310);
        objectSeq.put("schedule:file", 311);
        ...
        objectSeq.put("windowscalculationengine", 441);
        objectSeq.put("construction:complexfenestrationstate", 442);
        objectSeq.put("construction:windowequivalentlayer", 443);
        objectSeq.put("construction:windowdatafile", 444);
        objectSeq.put("construction:airboundary", 445);
        ...
        objectSeq.put("windowshadingcontrol", 527);
        ...
        objectSeq.put("surfaceproperty:heatbalancesourceterm", 605);
        objectSeq.put("surfacecontrol:movableinsulation", 606);
        objectSeq.put("surfaceproperty:othersidecoefficients", 607);
        objectSeq.put("surfaceproperty:othersideconditionsmodel", 608);
        objectSeq.put("surfaceproperty:underwater", 609);
        objectSeq.put("foundation:kiva",610);
        objectSeq.put("foundation:kiva:settings",611);
        objectSeq.put("surfaceproperty:exposedfoundationperimeter",612);
        objectSeq.put("surfaceconvectionalgorithm:inside:adaptivemodelselections", 613);
        objectSeq.put("surfaceconvectionalgorithm:outside:adaptivemodelselections", 614);
        objectSeq.put("surfaceconvectionalgorithm:inside:usercurve", 615);
        objectSeq.put("surfaceconvectionalgorithm:outside:usercurve", 616);
        objectSeq.put("surfaceproperty:convectioncoefficients", 617);
        objectSeq.put("surfaceproperty:convectioncoefficients:multiplesurface", 618);
        objectSeq.put("surfaceproperties:vaporcoefficients", 619);
        objectSeq.put("surfaceproperty:exteriornaturalventedcavity", 620);
        objectSeq.put("surfaceproperty:solarincidentinside", 621);
        objectSeq.put("surfaceproperty:localenvironment", 622);
        objectSeq.put("zoneproperty:localenvironment", 623);
        objectSeq.put("surfaceproperty:surroundingsurfaces", 624);
        objectSeq.put("complexfenestrationproperty:solarabsorbedlayers", 625);
        objectSeq.put("zoneproperty:userviewfactors:bysurfacename", 626);
        ...
        objectSeq.put("zonehvac:hybridunitaryhvac", 1713);
        objectSeq.put("zonehvac:outdoorairunit", 1714);
        objectSeq.put("zonehvac:outdoorairunit:equipmentlist", 1715);
        objectSeq.put("zonehvac:terminalunit:variablerefrigerantflow", 1716);
        ...
        objectSeq.put("airterminal:singleduct:constantvolume:noreheat", 1903);
        objectSeq.put("airterminal:singleduct:vav:noreheat", 1904);
        objectSeq.put("airterminal:singleduct:vav:reheat", 1905);
        objectSeq.put("airterminal:singleduct:vav:reheat:variablespeedfan", 1906);
        objectSeq.put("airterminal:singleduct:vav:heatandcool:noreheat", 1907);
        objectSeq.put("airterminal:singleduct:vav:heatandcool:reheat", 1908);
        objectSeq.put("airterminal:singleduct:seriespiu:reheat", 1909);
        objectSeq.put("airterminal:singleduct:parallelpiu:reheat", 1910);
        objectSeq.put("airterminal:singleduct:constantvolume:fourpipeinduction", 1911);
        objectSeq.put("airterminal:singleduct:constantvolume:fourpipebeam", 1912);
        objectSeq.put("airterminal:singleduct:constantvolume:cooledbeam", 1913);
        objectSeq.put("airterminal:singleduct:mixer", 1914);
        objectSeq.put("airterminal:dualduct:constantvolume", 1915);
        objectSeq.put("airterminal:dualduct:vav", 1916);
        objectSeq.put("airterminal:dualduct:vav:outdoorair", 1917);
        objectSeq.put("zonehvac:airdistributionunit", 1918);
        ...
        objectSeq.put("coil:cooling:dx", 2239);
        objectSeq.put("coil:cooling:dx:curvefit:performance", 2240);
        objectSeq.put("coil:cooling:dx:curvefit:operatingmode", 2241);
        objectSeq.put("coil:cooling:dx:curvefit:speed", 2242);
        ...
        objectSeq.put("airloophvac:dedicatedoutdoorairsystem", 2911);
        objectSeq.put("airloophvac:mixer", 2912);
        objectSeq.put("airloophvac:splitter", 2913);
        ...
        objectSeq.put("heatpump:plantloop:eir:cooling", 3513);
        objectSeq.put("heatpump:plantloop:eir:heating", 3514);
        objectSeq.put("heatpump:watertowater:equationfit:heating", 3515);
        objectSeq.put("heatpump:watertowater:equationfit:cooling", 3516);
        objectSeq.put("heatpump:watertowater:parameterestimation:cooling", 3517);
        objectSeq.put("heatpump:watertowater:parameterestimation:heating", 3518);
        objectSeq.put("districtcooling", 3519);
        objectSeq.put("districtheating", 3520);
        objectSeq.put("plantcomponent:temperaturesource", 3521);
        objectSeq.put("centralheatpumpsystem", 3522);
        objectSeq.put("chillerheaterperformance:electric:eir", 3523);
        ...
        objectSeq.put("groundheatexchanger:system", 3611);
        objectSeq.put("groundheatexchanger:vertical:properties", 3612);
        objectSeq.put("groundheatexchanger:vertical:array", 3613);
        objectSeq.put("groundheatexchanger:vertical:single", 3614);
        objectSeq.put("groundheatexchanger:responsefactors", 3615);
        objectSeq.put("groundheatexchanger:pond", 3616);
        objectSeq.put("groundheatexchanger:surface", 3617);
        objectSeq.put("groundheatexchanger:horizontaltrench", 3618);
        objectSeq.put("groundheatexchanger:slinky", 3619);
        objectSeq.put("heatexchanger:fluidtofluid", 3620);
        ...
        objectSeq.put("generator:pvwatts", 4708);
        objectSeq.put("electricloadcenter:inverter:pvwatts", 4709);
        objectSeq.put("generator:fuelcell", 4710);
        objectSeq.put("generator:fuelcell:powermodule", 4711);
        objectSeq.put("generator:fuelcell:airsupply", 4712);
        objectSeq.put("generator:fuelcell:watersupply", 4713);
        objectSeq.put("generator:fuelcell:auxiliaryheater", 4714);
        objectSeq.put("generator:fuelcell:exhaustgastowaterheatexchanger", 4715);
        objectSeq.put("generator:fuelcell:electricalstorage", 4716);
        objectSeq.put("generator:fuelcell:inverter", 4717);
        objectSeq.put("generator:fuelcell:stackcooler", 4718);
        objectSeq.put("generator:microchp", 4719);
        objectSeq.put("generator:microchp:nonnormalizedparameters", 4720);
        objectSeq.put("generator:fuelsupply", 4721);
        objectSeq.put("generator:windturbine", 4722);
        objectSeq.put("electricloadcenter:generators", 4723);
        objectSeq.put("electricloadcenter:inverter:simple", 4724);
        objectSeq.put("electricloadcenter:inverter:functionofpower", 4725);
        objectSeq.put("electricloadcenter:inverter:lookuptable", 4726);
        objectSeq.put("electricloadcenter:storage:simple", 4727);
        objectSeq.put("electricloadcenter:storage:battery", 4728);
        objectSeq.put("electricloadcenter:transformer", 4729);
        objectSeq.put("electricloadcenter:distribution", 4730);
        ...
        objectSeq.put("faultmodel:temperaturesensoroffset:returnair", 4904);
        objectSeq.put("faultmodel:enthalpysensoroffset:returnair", 4905);
        objectSeq.put("faultmodel:temperaturesensoroffset:chillersupplywater", 4906);
        objectSeq.put("faultmodel:temperaturesensoroffset:coilsupplyair", 4907);
        objectSeq.put("faultmodel:temperaturesensoroffset:condensersupplywater", 4908);
        objectSeq.put("faultmodel:thermostatoffset", 4909);
        objectSeq.put("faultmodel:humidistatoffset", 4910);
        objectSeq.put("faultmodel:fouling:airfilter", 4911);
        objectSeq.put("faultmodel:fouling:boiler", 4912);
        objectSeq.put("faultmodel:fouling:evaporativecooler", 4913);
        objectSeq.put("faultmodel:fouling:chiller", 4914);
        objectSeq.put("faultmodel:fouling:coolingtower", 4915);
        objectSeq.put("faultmodel:fouling:coil", 4916);
        ...
        objectSeq.put("table:independentvariable", 5201);
        objectSeq.put("table:independentvariablelist", 5202);
        objectSeq.put("table:lookup", 5203);
        ...
        objectSeq.put("output:json", 5621);
        objectSeq.put("output:sqlite", 5622);
        objectSeq.put("output:environmentalimpactfactors", 5623);
        objectSeq.put("environmentalimpactfactors", 5624);
        objectSeq.put("fuelfactors", 5625);
        objectSeq.put("output:diagnostics", 5626);
        objectSeq.put("output:debuggingdata", 5627);
        objectSeq.put("output:preprocessormessage", 5628);
        objectSeq.put("outputcontrol:files", 5629);
        
        objectSeq.put("pythonplugin:searchpaths", 5701);
        objectSeq.put("pythonplugin:instance", 5702);
        objectSeq.put("pythonplugin:variables", 5703);
        objectSeq.put("pythonplugin:trendvariable", 5704);
        objectSeq.put("pythonplugin:outputvariable", 5705);
