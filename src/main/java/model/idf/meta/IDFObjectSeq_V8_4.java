...
public class IDFObjectSeq_V8_4 implements ObjectSeq {
    ...
    private static void initObjectSeq(){
        ...
        objectSeq.put("airflownetwork:occupantventilationcontrol", 1224);
        objectSeq.put("airflownetwork:intrazone:node", 1225);
        objectSeq.put("airflownetwork:intrazone:linkage", 1226);
        ...
        objectSeq.put("airterminal:singleduct:inletsidemixer", 1913);
        objectSeq.put("airterminal:singleduct:supplysidemixer", 1914);
        ...
        objectSeq.put("coil:heating:gas", 2217);
        ...
        objectSeq.put("coil:cooling:dx:singlespeed:thermalstorage", 2237);
