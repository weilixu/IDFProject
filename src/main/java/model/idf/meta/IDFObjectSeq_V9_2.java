...
public class IDFObjectSeq_V9_2 implements ObjectSeq{
    ...
    private static void initObjectSeq(){
        ...
        objectSeq.put("heatpump:watertowater:eir:cooling", 3513);
        objectSeq.put("heatpump:watertowater:eir:heating", 3514);
