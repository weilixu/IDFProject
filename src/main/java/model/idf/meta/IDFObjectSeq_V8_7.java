...
public class IDFObjectSeq_V8_7 implements ObjectSeq{
    ...
    private static void initObjectSeq(){
        ...
        objectSeq.put("materialproperty:variablethermalconductivity", 427);
        objectSeq.put("materialproperty:heatandmoisturetransfer:settings", 428);
        objectSeq.put("materialproperty:heatandmoisturetransfer:sorptionisotherm", 429);
        objectSeq.put("materialproperty:heatandmoisturetransfer:suction", 430);
        objectSeq.put("materialproperty:heatandmoisturetransfer:redistribution", 431);
        objectSeq.put("materialproperty:heatandmoisturetransfer:diffusion", 432);
        objectSeq.put("materialproperty:heatandmoisturetransfer:thermalconductivity", 433);
        objectSeq.put("materialproperty:glazingspectraldata", 434);
        objectSeq.put("construction", 435);
        objectSeq.put("construction:cfactorundergroundwall", 436);
        objectSeq.put("construction:ffactorgroundfloor", 437);
        objectSeq.put("construction:internalsource", 438);
        objectSeq.put("windowthermalmodel:params", 439);
        objectSeq.put("construction:complexfenestrationstate", 440);
        objectSeq.put("construction:windowequivalentlayer", 441);
        objectSeq.put("construction:windowdatafile", 442);
        ...
        objectSeq.put("foundation:kiva",608);
        objectSeq.put("foundation:kiva:settings",609);
        objectSeq.put("surfaceproperty:exposedfoundationperimeter",610);
        objectSeq.put("surfaceconvectionalgorithm:inside:adaptivemodelselections", 611);
        objectSeq.put("surfaceconvectionalgorithm:outside:adaptivemodelselections", 612);
        objectSeq.put("surfaceconvectionalgorithm:inside:usercurve", 613);
        objectSeq.put("surfaceconvectionalgorithm:outside:usercurve", 614);
        objectSeq.put("surfaceproperty:convectioncoefficients", 615);
        objectSeq.put("surfaceproperty:convectioncoefficients:multiplesurface", 616);
        objectSeq.put("surfaceproperties:vaporcoefficients", 617);
        objectSeq.put("surfaceproperty:exteriornaturalventedcavity", 618);
        objectSeq.put("surfaceproperty:solarincidentinside", 619);
        objectSeq.put("complexfenestrationproperty:solarabsorbedlayers", 620);
        objectSeq.put("zoneproperty:userviewfactors:bysurfacename", 621);
