...
public final class SPA {
    ...
    public static void main(String[] args){
        ...
        //GregorianCalendar time = new GregorianCalendar(new SimpleTimeZone(-5 * 60 * 60 * 1000, "EST"));
        GregorianCalendar time = new GregorianCalendar();
        JsonArray ja = new JsonArray();
        for(int i=0;i<24;i++){
            time.set(2017, Calendar.APRIL, 5, i, 00, 00); // 17 October 2003, 12:30:30 LST-07:00
            
            AzimuthZenithAngle result = SPA.calculateSolarPosition(time, 40.4406, -79.9959, 416, DeltaT.estimate(time));
