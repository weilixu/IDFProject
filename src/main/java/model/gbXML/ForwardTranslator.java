...
public class ForwardTranslator {
    ...
    private Element translateBuilding(){
        ...
        buildingElement.setAttribute("id", escapeName(bldg.getDataByStandardComment("Name")));
        ...
        nameElement.setText(bldg.getDataByStandardComment("Name"));
    ...
    private Element translateLocationObject(IDFObject siteLocation){
        ...
        locName.setText(siteLocation.getDataByStandardComment("Name"));//temp solution
        location.addContent(locName);
        
        String latitude = siteLocation.getDataByStandardComment("Latitude");//wait for test
        if(latitude!=null){
        ...
        longitude.setText(siteLocation.getDataByStandardComment("Longitude"));
        location.addContent(longitude);
        Element elevation = new Element("Elevation");
        elevation.setText(siteLocation.getDataByStandardComment("Elevation"));
