...
public class EnergyPlusFieldTemplate implements Serializable{
    ...
    private static final String REFERENCETOKEN_CLASS = "\\reference-class-name";
    ...
    private Double inclusiveMin = NumUtil.MIN_VALUE;
    private Double Min = NumUtil.MIN_VALUE;
    private Double inclusiveMax = NumUtil.MAX_VALUE;
    private Double Max = NumUtil.MAX_VALUE;
    private String fieldDefault = null;
    private String type = "";
    
    private List<String> keyList = new ArrayList<>();
    private List<String> reference = new ArrayList<>();
    private List<String> classReference = new ArrayList<>();
    private List<String> objectListRef = new ArrayList<>();
    ...
    public void setFieldIdx(int idx){
        this.fieldIdx = idx;
    }
    
    public void setObjName(String objLabel){
    	objName = objLabel;
    }
    ...
    public List<String> getClassReference(){
    ...
    public void processElement(String line){
        if(line.contains(NOTETOKEN)){
            ...
            String num = getContentFromLine(line,MINTOKEN).trim();
            if(num.startsWith(">")){
                num = num.substring(1).trim();
                Min = NumUtil.parseDouble(num);
            }else {
                inclusiveMin = NumUtil.parseDouble(num);
            }
            ...
            if(num.startsWith("<")){
                ...
                inclusiveMax = Double.parseDouble(num);
            }
        ...
        }else if(line.contains(REFERENCETOKEN_CLASS)){
        	classReference.add(getContentFromLine(line,REFERENCETOKEN_CLASS));
